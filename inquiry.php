...
$carts = getCartItems();
if($_POST['cupdate']){updateCart("inquiry");}
if($_POST['cdell']){deleteCart("inquiry");}
if($_POST['sub_mit_inq'] == 1){submitInq();}
$id = 42;
?>
...
<?=cleanOut(getcmsF($id));?>
			...
			<?php
			if(!$carts):
			echo "<p class=\"bg-danger xmsgred\">Your basket is Empty!</p>";else: ?>
			<div class="col-lg-12">
...
<input type="text" required class="form-control" id="company" name="icompany" placeholder="Enter Your Company Name">
...
<input type="text" required class="form-control" id="city" name="icity" placeholder="Enter Your City">
...
<input type="text" required class="form-control" id="mobile" name="imobile" placeholder="Enter Your Mobile Number">
...
<label for="payment">Payment Methoad:</label>

<select name="ipayment" class="form-control" id="payment">
...
<select name="ishipping" class="form-control" id="shipping">
...
<input type="hidden" name="sub_mit_inq" value="1">
